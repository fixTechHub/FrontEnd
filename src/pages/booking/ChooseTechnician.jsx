...
function ChooseTechnician() {
    ...
    const { bookingPrice, status: quotationStatus } = useSelector((state) => state.bookingPrice);
                                            ...
                                            <div className="modal-dialog modal-dialog-centered modal-md">
                                                <div className="modal-content">
                                                    ...
                                                    <div className="modal-body pb-1">
                                                        ...
                                                        <div className="mb-3">
                                                            <label className="form-label">
                                                                Tiền công: <span className="text-danger">{bookingPrice?.quotation.laborPrice} VND</span>
                                                            </label>
                                                        </div>
                                                        ...
                                                        {Array.isArray(bookingPrice?.items) && bookingPrice?.items.map((item) => (
                                                            <div className="mb-3">
                                                                <label className="form-label">
                                                        ...
                                                        <div className="mb-3">
                                                            <label className="form-label">
                                                                Tiền tạm tính: <span className="text-danger">{bookingPrice?.quotation.finalPrice} VND</span>
                                                            </label>
                                                        </div>
