...
const TechnicianSubscriptionDashboard = () => {
      ...
      <div className="modern-content-card">
        <div className="container-fluid">
          <Space direction="vertical" size={24} style={{ width: '100%' }}>
            ...
            <Row justify="space-between" align="middle">
              <Col>
                <AntTitle level={2} style={{ margin: 0, fontWeight: 600 }}>
                  Dashboard Phân Tích Doanh Thu Gói Đăng Ký
                </AntTitle>
                <Text type="secondary">
                  Thống kê và phân tích chi tiết doanh thu từ gói đăng ký kỹ thuật viên
                </Text>
              </Col>
              <Col>
                <Space>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
                <Card title="Doanh Thu Theo Tháng" style={{ height: 400 }}>
                  <Line data={revenueChartData} options={chartOptions} />
                </Card>
              </Col>
              <Col xs={24} lg={12}>
                <Card title="Lượt Mua Gói Theo Tháng" style={{ height: 400 }}>
...
export default TechnicianSubscriptionDashboard;
